...
export function LoadingScreen({text = "Rendszer betöltése..."}: { text?: string }) {
  return (
    <div
      ...
      <div
        className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-yellow-900/20 via-slate-950 to-slate-950"/>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-slate-900">
        <div className="h-full bg-yellow-600 animate-progress w-full origin-left scale-x-0"
